    ...
    window.visDetaljer = function(id, startFane = 'detaljer') {
      ...
      document.getElementById('detaljer-innhold').innerHTML = `
        <div style="display:grid;gap:0.75rem;">
          ...
          ${s.status === 'godkjent' ? `<div style="background:#F0FDF4;border:2px solid #16a34a;border-radius:var(--radius);padding:1.5rem;margin-top:1.25rem;"><p style="font-size:1.1rem;font-weight:600;color:#15803d;margin:0 0 0.75rem;">Du har fått læreplassen!</p><p style="margin:0 0 1rem;font-size:0.95rem;color:#166534;line-height:1.7;">Opplæringskontoret i Vestland tar det herfra. Du vil motta en SMS med invitasjon til <strong>fagbrev.io</strong> på telefonnummeret ditt. Der dokumenterer du læretiden, registrerer timer og følger opp kompetansemål.</p><p style="margin:0;font-size:0.85rem;color:#166534;">Spørsmål? Send en melding i chatten.</p></div>` : ''}
        </div>`;
